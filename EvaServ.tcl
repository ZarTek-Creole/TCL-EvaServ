...
proc ::EvaServ::INIT { } {
	...
	proc ::EvaServ::Service:Connexion { } {
		...
		proc ::EvaServ::rehash { arg } {
			...
			proc ::EvaServ::help:description:status {}			{ variable SCRIPT; return "Permet de voir les informations de ${SCRIPT(name)}." }
			...
			proc ::EvaServ::help:description:accessadd {}		{ variable SCRIPT; return "Permet d'ajouter un accès sur ${SCRIPT(name)}." }
